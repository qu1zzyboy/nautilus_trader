...
impl TrendStrength {
    /// Creates a new `TrendStrength` instance.
    #[new]
    #[pyo3(signature = (period=60, price_type=None, ewm_alpha=0.1, normalization_period=5000))]
    fn py_new(
        period: usize,
        ...
        Self::new(period, price_type, ewm_alpha, normalization_period)
    }

    fn __repr__(&self) -> String {
        format!(
            "TrendStrength({}, {}, {})",
            self.period, self.ewm_alpha, self.normalization_period
        )
    }
